...
extern "C" void Main()
{
  ...
  static constexpr auto AK5C_PATH = "Gameplay/Weapons/AK5C/AK5C";
  static constexpr auto AK5C_PATH_SIZE = __builtin_strlen(AK5C_PATH) + 1;
  static constexpr auto AK5C_ROF = 0x442f0000;
  ...
  while (true)
  {
    ...
    {
      uint64_t ak5cRof = readMemory(processHandle, ak5cRofLocation) + 0x1C8ull;
